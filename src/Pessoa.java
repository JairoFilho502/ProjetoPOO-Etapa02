public abstract class Pessoa {
    ...
    // SOBRECARGA: construtores com diferentes parametros
    ...
    // R2 — protected: acessivel apenas pelas subclasses para montar o resumo
    protected String formatarDadosBase() {
        return "Nome: " + nome + " | CPF: " + cpf
                + " | Idade: " + idade + " | Tel: " + telefone;
    }

    // R6 — metodo abstrato obriga subclasses a implementar exibicao propria
